...
// Recipe model mirroring the Rust core types from GeekBread_Code_Spec.md §3.3.
...
enum RecipeSource: Codable, Hashable {
    case original                                                       // GeekBread-authored
    ...
    var label: String {
        switch self {
        case .original: return "GeekBread"
