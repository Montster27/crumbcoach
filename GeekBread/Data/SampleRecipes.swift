...
enum SampleRecipes {
    ...
    static let baguette = Recipe(
        ...
        totalDoughGrams: 1045, loafCount: 3,
        timeToBake: "18h overnight",
        tags: ["overnight"],
        twinScald: false,
        preferments: [
            Preferment(
                ...
                technique: "100% hydration · rest 12–14h",
                prep: "Whisk flour, water, and a pinch of yeast. Cover and rest at room temp 12–14h until bubbly and domed.",
                flourPct: 25,
                ingredients: [
                    Ingredient(name: "Bread flour",   category: .flour,  weightGrams: 150, bakersPct: 25,   section: "poolish"),
                    Ingredient(name: "Water",         category: .liquid, weightGrams: 150, bakersPct: 25,   section: "poolish"),
                    Ingredient(name: "Instant yeast", category: .leaven, weightGrams: 0.5, bakersPct: 0.08, section: "poolish"),
                ]
            )
        ],
        ingredients: [
            Ingredient(name: "Bread flour",   category: .flour,  weightGrams: 450,  bakersPct: 75,  section: "main"),
            Ingredient(name: "Water",         category: .liquid, weightGrams: 282,  bakersPct: 47,  section: "main"),
            Ingredient(name: "Salt",          category: .salt,   weightGrams: 11,   bakersPct: 1.8, section: "main"),
            Ingredient(name: "Instant yeast", category: .leaven, weightGrams: 1.9,  bakersPct: 0.3, section: "main"),
        ],
        stages: [
            Stage(kind: .prepPoolish, durationMin: 720, durationMaxMin: 840, temperatureC: 22, note: "Mix poolish, cover, rest overnight until bubbly", scaldRef: "poolish"),
            Stage(kind: .mix,         durationMin: 10,  temperatureC: 24, note: "Combine poolish, water, yeast, flour, salt until shaggy"),
    ...
    static let focaccia = Recipe(
        ...
        breadType: .leanYeasted,
        source: .linked(url: "https://www.theperfectloaf.com/a-simple-focaccia/",
    ...
    static let shokupan = Recipe(
        ...
        breadType: .enriched,
        source: .linked(url: "https://www.theperfectloaf.com/sourdough-shokupan/",
