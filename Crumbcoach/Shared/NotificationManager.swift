...
final class NotificationManager {
    ...
    static let bakeReminderTapped = Notification.Name("CrumbCoach.bakeReminderTapped")
    ...
    private init() {
        ...
        // running. CrumbcoachApp.init touches `.shared` to force this.
        let d = Delegate()
        self.delegate = d
    ...
    private func actionPoints(for step: ScheduleStep,
        ...
        case .feedLevain, .prepYudane, .cookTangzhong, .autolyse,
