...
struct OnboardingScreen: View {
    ...
    private var pitchPage: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Sourdough, enriched doughs, baguettes, focaccia, ciabatta — GeekBread scales recipes to your kitchen, weighs ingredients in your units, and tracks every fold so you don't have to.")
    ...
    private var howPage: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("Bake with the timer.")
                ...
                .foregroundStyle(Theme.slate900)
                .fixedSize(horizontal: false, vertical: true)
            Text("Each bake walks you stage by stage. GeekBread pings you for folds, reflows the schedule when you run late, and remembers what worked so the next bake is better.")
                .font(Typography.ui(15))
                .foregroundStyle(Theme.slate700)
                .fixedSize(horizontal: false, vertical: true)
