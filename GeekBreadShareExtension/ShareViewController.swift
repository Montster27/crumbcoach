...
// Safari → Share → GeekBread. The extension reads the shared URL from the
// extension context's input items, encodes it as a `geekbread://import`
...
// tapped Share → GeekBread and any extra screen is friction. A subclass
...
class ShareViewController: UIViewController {
    ...
    /// Hand the shared URL to the main app via the `geekbread://import`
