...
enum SharedContainer {
    ...
    /// Same App Group identifier in `GeekBread.entitlements` and
    /// `GeekBreadWidgets.entitlements`. Forks to another team change all
    /// three references (plus the team id) in lockstep.
    static let groupIdentifier = "group.com.monty.geekbread.shared"
