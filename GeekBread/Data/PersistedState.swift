...
struct PersistedState: Codable {
    ...
    /// Stage 24 — whether the user has opted in to Anthropic Claude
    /// (Haiku) for crumb diagnosis, starter health, and recipe-import
    /// structural cleanup. Defaults to false. The API key itself lives
    /// in Keychain, not here.
